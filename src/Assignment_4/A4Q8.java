...
//User enters their name and it is saved as userName1
        String userName1 = userName.getText();
//The text box sets the text to hello users name
        textArea.setText("Hello " + userName1);
